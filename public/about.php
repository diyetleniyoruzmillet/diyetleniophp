        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-section">
                    <h4><i class="fas fa-heartbeat me-2"></i>Diyetlenio</h4>
                    <p style="color: #cbd5e1; line-height: 1.7;">
                        Sağlıklı yaşam için profesyonel diyetisyen desteğini herkes için erişilebilir kılıyoruz.
                    </p>
                ...
                <div class="footer-section">
                    ...
                    <ul style="list-style: none; padding: 0;">
                        ...
                        <li style="margin-bottom: 12px; color: #cbd5e1;">
                            <i class="fas fa-phone me-2" style="color: #0ea5e9;"></i>
                            +90 (212) 123 45 67
                        </li>
                        <li style="color: #cbd5e1;">
                            <i class="fas fa-map-marker-alt me-2" style="color: #0ea5e9;"></i>
                            İstanbul, Türkiye
                        </li>
                    </ul>
                </div>

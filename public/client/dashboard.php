<?php
/**
 * Client Dashboard - Randevular ve Video Görüşme
 */
...
$stmt = $conn->prepare("
    ...
    LEFT JOIN users u ON a.dietitian_id = u.id
    LEFT JOIN dietitian_profiles dp ON a.dietitian_id = dp.user_id
    WHERE a.client_id = ? AND (a.status = 'completed' OR
...
<div class="dashboard-container">
        ...
        <div class="appointment-card">
            <div class="appointment-header">
                <div class="dietitian-info">
                    <img src="<?= clean($photoUrl) ?>" alt="<?= clean($appointment['dietitian_name']) ?>" class="dietitian-avatar">
                    <div>
                        <div class="dietitian-name"><?= clean($appointment['dietitian_name']) ?></div>
    ...
    <?php else: ?>
        <div class="empty-state">
            ...
            <p>Bir diyetisyenle randevu oluşturun ve sağlıklı yaşam yolculuğunuza başlayın!</p>
            <a href="/dietitians.php" class="btn-primary-custom">

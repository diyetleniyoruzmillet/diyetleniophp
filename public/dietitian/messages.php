            ...
            <div class="col-md-2 sidebar p-0">
                <div class="p-4">
                    ...
                    <nav class="nav flex-column">
                        ...
                        <a class="nav-link active" href="/dietitian/messages.php">
                    ...
                    <?php if (count($conversations) === 0): ?>
                        <div class="card">
                            <div class="card-body text-center py-5">
                                ...
                                <p class="text-muted">Danışanlarınızla mesajlaşmaya başlayın.</p>
                            </div>
                        </div>
                    <?php else: ?>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-4 conversations-list">
                                    ...
                                    <?php foreach ($conversations as $conv): ?>
                                        <a href="?client_id=<?= $conv['id'] ?>" class="text-decoration-none">

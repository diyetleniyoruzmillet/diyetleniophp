...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
            ...
            <div class="ms-auto">
                <?php if ($auth->check()): ?>
                    <a href="/<?= $auth->user()->getUserType() ?>/dashboard.php" class="btn btn-success">
                        <i class="fas fa-user-circle me-1"></i><?= clean($auth->user()->getFullName()) ?>
                    </a>
                <?php else: ?>
                    <a href="/login.php" class="btn btn-outline-success me-2">Giriş</a>
                    <a href="/register-client.php" class="btn btn-success">Kayıt Ol</a>
                <?php endif; ?>
            </div>
        </div>
    </nav>

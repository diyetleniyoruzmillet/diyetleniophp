<?php
/**
 * Diyetlenio - Şifremi Unuttum Sayfası
 */
...
<body>
    <div class="forgot-container">
        <div class="forgot-card">
            ...
            <p class="form-subtitle">Email adresinizi girin, size şifre sıfırlama linki gönderelim</p>
            ...
            <?php if ($success): ?>
                <div class="alert alert-success alert-dismissible fade show">
                    ...
                    Eğer bu email adresi sistemimizde kayıtlıysa, şifre sıfırlama linki gönderildi. Lütfen email kutunuzu kontrol edin.
                    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                </div>
            <?php else: ?>
                <form method="POST">
                    ...
                    <button type="submit" class="btn btn-submit">
                        <i class="fas fa-paper-plane me-2"></i>Sıfırlama Linki Gönder
                    </button>
                </form>
            <?php endif; ?>

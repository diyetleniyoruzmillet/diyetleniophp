...
<head>
    ...
    <meta name="description" content="Diyetlenio kullanımı hakkında yardım ve destek. Sıkça sorulan sorular, rehberler ve daha fazlası.">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="/help">Yardım</a>
                    </li>
                    <?php if ($auth->check()): ?>
                        <li class="nav-item">
